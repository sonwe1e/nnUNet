...
# CUDA_VISIBLE_DEVICES=0 nnUNetv2_train 010 3d_fullres_big_patch all -tr DodTrainer --npz --exp_name dodnet_baseline_1000_0.88_192
# CUDA_VISIBLE_DEVICES=1 nnUNetv2_train 010 3d_fullres_big_patch all -tr DodTrainer --npz --exp_name dodnet_baseline_2000_0.66_192
CUDA_VISIBLE_DEVICES=2 nnUNetv2_train 010 3d_fullres_big_patch all -tr DodTrainer --npz --exp_name dodnet_mschead_1000_0.66_192

# CUDA_VISIBLE_DEVICES=1 nnUNetv2_train 011 3d_fullres 1 --npz --exp_name nnunet_1000_0.33_deep &
